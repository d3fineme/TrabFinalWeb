		    ...
		    <form action="checkout3.php" method="post" class="col s10 m10 l10 push-l1">
		      	<div class="row">
			        <div class="input-field col s4">
			          	<input id="first_name" type="text" class="validate" value="<?php echo $name; ?>">
			          	<label for="first_name">Nome</label>
			        </div>
			        <div class="input-field col s4">
			          	<input id="last_name" type="text" class="validate" value="<?php echo $sobrenome; ?>">
		      	...
		      	<div class="row">
			        <div class="input-field col s4">
			          <input id="end" type="text" class="validate" value="<?php echo $street; ?>">
			          <label for="end">Endereço</label>
		        	</div>
			        <div class="input-field col s4">
			        	<input id="cidade" type="text" class="validate" value="<?php echo $city; ?>">
			          	<label for="cidade">Cidade</label>
			        </div>
			        <div class="input-field col s2">
			          	<input id="estado" type="text" class="validate" value="<?php echo $state; ?>">
			          	<label for="estado">Estado</label>
			        </div>
			        <div class="input-field col s2">
			          	<input id="cep" type="number" class="validate" value="<?php echo $zip; ?>">
                    ...
                    <div class="row">
                        <form action="checkout3.php" method="post" class="col s10 m10 l10 push-l1">
                            <div class="row">
                                ...
                                <div class="input-field col s4">
                                    <input id="email" type="email" class="validate" value="<?php echo $_POST['email']; ?>">
                                    <label for="email">Email</label>
                                </div>
                            </div>
                            <div class="row">
